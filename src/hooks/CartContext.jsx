...
export const CartProvider = ({children}) => {
    ...
    const cartKey = `devburguer:cartInfo:${userId}`
    ...
    useEffect(() => {
        const clientCartData = localStorage.getItem(cartKey)

        if(clientCartData){ //se encontrar tal item no localStorage, vai transformar no que era antes
...
export const UseCart = () => { //usar o UseCart para quando precisarmos usar cada item do value
